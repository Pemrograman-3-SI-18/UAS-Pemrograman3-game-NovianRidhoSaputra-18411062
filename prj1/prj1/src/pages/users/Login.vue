                ...
                <div class="col-md-6 col-xs-12">
                  <div class="row q-pt-md q-pb-md bg-teal-5">
                    <div class="col-md-8 offset-2 col-xs-8">
                      <q-img spinner-color="blue" placeholder-src="statics/user.png" src="statics/user.png"></q-img>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="q-pa-md">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <q-btn label="Register" to="/auth/register"  color="primary" flat class="q-ml-sm" />
                      </div>
                    </q-form>
